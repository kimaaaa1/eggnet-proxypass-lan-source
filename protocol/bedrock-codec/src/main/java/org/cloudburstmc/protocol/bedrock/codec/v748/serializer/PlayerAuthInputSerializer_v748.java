...
public class PlayerAuthInputSerializer_v748 extends PlayerAuthInputSerializer_v712 {
    ...
    public void deserialize(ByteBuf buffer, BedrockCodecHelper helper, PlayerAuthInputPacket packet) {
        ...
        packet.setInputMode(NullableEnum.get(INPUT_MODES, VarInts.readUnsignedInt(buffer)));
        packet.setPlayMode(NullableEnum.get(CLIENT_PLAY_MODES, VarInts.readUnsignedInt(buffer)));

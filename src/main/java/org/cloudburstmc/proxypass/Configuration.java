...
public class Configuration {
    ...
    public static class Destination {
        ...
        @JsonProperty("pmsg-id")
        private String pmsgId;
        @JsonProperty("local-network-id")
        private String localNetworkId;
        @JsonProperty("advertised-server-name")
        private String advertisedServerName;
        @JsonProperty("advertised-level-name")
        private String advertisedLevelName;
        @JsonProperty("advertised-player-count")
        private Integer advertisedPlayerCount;
        @JsonProperty("advertised-max-player-count")
        private Integer advertisedMaxPlayerCount;
        @JsonProperty("advertised-connection-type")
        private Integer advertisedConnectionType;
        @JsonProperty("advertised-transport-layer")
        private Integer advertisedTransportLayer;
        @JsonProperty("advertised-game-type")
        private Integer advertisedGameType;
        @JsonProperty("transport")
        private String transport = "raknet";
    }
}
